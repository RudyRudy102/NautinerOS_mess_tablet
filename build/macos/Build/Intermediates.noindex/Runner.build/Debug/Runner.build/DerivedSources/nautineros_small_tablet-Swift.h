...
#ifndef NAUTINEROS_SMALL_TABLET_SWIFT_H
#define NAUTINEROS_SMALL_TABLET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="nautineros_small_tablet",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC23nautineros_small_tablet11AppDelegate")
...
SWIFT_CLASS("_TtC23nautineros_small_tablet17MainFlutterWindow")
